...
while True:
    ...
    if results.multi_hand_landmarks and results.multi_handedness:
        for i , handLms in enumerate(results.multi_hand_landmarks):
            ...
            index = handLms.landmark[mp_hands.HandLandmark.INDEX_FIGER_TIP]
            thumb_pos = (int(thumb.x * w), int(thumb.y * w))
            ...
            if label == 'Right':
                ...
                cv2.rectangle(img, (x2, bright_bar), (x2, 400), (0, 255, 0), cv2.FILLED)
